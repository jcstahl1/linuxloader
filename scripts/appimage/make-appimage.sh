...
APPIMAGENAME=linuxloader
APPIMAGEDIRNAME=linuxloader.AppDir
...
exec "$APP_IMG_ROOT/usr/bin/linuxloader" "$@"
EOF
...
cp linuxloader.so $OUTPUT_FOLDER/usr/lib
cp libposixtime.so $OUTPUT_FOLDER/usr/lib
cp linuxloader $OUTPUT_FOLDER/usr/bin
...
--desktop-file="./scripts/linuxloader.desktop" \
--icon-file="./scripts/linuxloader.png" 
...
mv $OUTPUT_FOLDER/usr/lib/linuxloader.so $OUTPUT_FOLDER/usr/lib32
...
unzip libs/linux_x86/Cg-3.1.zip -d $OUTPUT_FOLDER/usr/lib32
cp libs/linux_x86/libCg.so $OUTPUT_FOLDER/usr/lib32/libCg2.so
cp libs/linux_x86/libopenal.so.0 $OUTPUT_FOLDER/usr/lib32/libopenal.so.0
cp libs/linux_x86/libcrypto.so.0.9.7 $OUTPUT_FOLDER/usr/lib32/libcrypto.so.0.9.7
cp libs/linux_x86/libssl.so.0.9.7 $OUTPUT_FOLDER/usr/lib32/libssl.so.0.9.7
