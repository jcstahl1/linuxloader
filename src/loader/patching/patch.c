...
int initPatch()
{
    ...
    switch (gId)
    {
        case AFTER_BURNER_CLIMAX_SBLR: // DVP-0009
        {
            // Security
            ...
            detourFunction((size_t)findStaticFnAddr("_Z11dest_io_usbv"), stubReturn);
        }
        break;
        case AFTER_BURNER_CLIMAX_SBLR_REVA: // DVP-0009A
        {
            // Security
            ...
            // Network
            // detourFunction(0x080fc892, abcSetNetworkInterface);
            // patchMemory(0x080fbbee, "9090");
            // patchMemory(0x080fbbf4, "9090");
        }
        break;
        case AFTER_BURNER_CLIMAX_SBLR_REVB: // DVP-0009B
        {
            // Security
            ...
            // Network
            // detourFunction(0x080fc89a, abcSetNetworkInterface);

            //            detourFunction(0x08058486, _putConsole);

            // replaceCallAtAddress(0x080fd404, abcBind);
            // replaceCallAtAddress(0x080fd4bd, abcRecvFrom);
        }
        break;
        case AFTER_BURNER_CLIMAX_SDX_SBMN: // DVP-0018
        {
            // Security
        ...
        break;
        case AFTER_BURNER_CLIMAX_SDX_SBMN_REVA: // DVP-0018A
        {
            // Security
            ...
            detourFunction((size_t)findStaticFnAddr("_Z11dest_io_usbv"), stubReturn);
            // Network
            // detourFunction(0x080fcbca, abcSetNetworkInterface);
            // patchMemory(0x080fbbee, "9090");
            // patchMemory(0x080fbbf4, "9090");
        }
        break;
        case AFTER_BURNER_CLIMAX_SE_SBLR: // DVP-0031
        {
            // Security
        ...
        break;
        case AFTER_BURNER_CLIMAX_SE_SBLR_REVA: // DVP-0031A
        {
            // Security
        ...
        case GHOST_SQUAD_EVOLUTION_SBNJ:
        {
            ...
            patchMemoryFromString(0x080f37dd, "EB"); // patch to prevent memory assignment error
        ...
        break;
        case HUMMER_SBQN_REVB: // DVP-0057B
        {
            if (config->showDebugMessages == 1)
            {
        ...
        break;
        case HUMMER_EXTREME_SBST: // DVP-0079
        {
            if (config->showDebugMessages == 1)
            {
        ...
        case INITIALD_4_EXP_SBNK_REVB:
        {
            ...
            if (GPUVendor != NVIDIA_GPU)
            {
                ...
                if (GPUVendor == ATI_GPU)
                    detourFunction(0x08078f80, gl_ProgramStringARB);
                // else
        ...
        case INITIALD_4_EXP_SBNK_REVD:
        {
            ...
            if (GPUVendor != NVIDIA_GPU)
            {
                ...
                if (GPUVendor == ATI_GPU)
                    detourFunction(0x0807900c, gl_ProgramStringARB);
                // else
                //     patchMemoryFromString(0x0854b4a0, "9090");
            }
        ...
        case INITIALD_4_SBML_REVA:
        {
            ...
            if (GPUVendor != NVIDIA_GPU)
            {
                ...
                if (GPUVendor == ATI_GPU)
                    detourFunction(0x080790b0, gl_ProgramStringARB);
                // else
        ...
        case INITIALD_4_SBML_REVB:
        {
            ...
            if (GPUVendor != NVIDIA_GPU)
            {
                ...
                if (GPUVendor == ATI_GPU)
                    detourFunction(0x080790d4, gl_ProgramStringARB);
                // else
        ...
        break;
        case INITIALD_4_SBML_SERVERBOX:
        {
            if (config->showDebugMessages == 1)
            {
            ...
            patchMemoryFromString(0x0807fa1b, "e93b020000"); // skip network check

            // detourFunction(0x08114034, stubRetThree); // altrServer()
            //            detourFunction(0x0807f37e, getHostByName);
        ...
        case INITIALD_4_SBML_REVG:
        {
            ...
            if (GPUVendor != NVIDIA_GPU)
            {
                ...
                if (GPUVendor == ATI_GPU)
                    detourFunction(0x0807a9c8, gl_ProgramStringARB);
                // else
        ...
        case INITIALD_4_SBML_REVZ:
        {
            if (config->showDebugMessages == 1)
            {
                ...
                setVariable(0x08dde3b4, 2);                      // amOsinfoDebugLevel
                setVariable(0x08dde3c4, 0x0FFFFFFF);             // s_logMask
                detourFunction(0x08565798, _putConsoleSeparate); // Debug Messages
            }
            // Security
            detourFunction(0x0872d1c6, amDongleInit);
            detourFunction(0x0872bc11, amDongleIsAvailable);
            detourFunction(0x0872c675, amDongleUpdate);
            detourFunction(0x0872d08d, amDongleUserInfoEx);
            memcpy(elfID, (void *)0x08350223, 4); // Gets gameID from the ELF
            //  Fixes
            amDipswContextAddr = (void *)0x08e0d7a8; // Address of amDipswContext
            detourFunction(0x0872b9a4, amDipswInit);
            detourFunction(0x0872ba28, amDipswExit);
            detourFunction(0x0872ba9d, amDipswGetData);
            detourFunction(0x0872bb14, amDipswSetLed); // amDipswSetLED

            detourFunction(0x0823809a, stubRetOne);          // isEthLinkUp
            patchMemoryFromString(0x082f4346, "c0270900");   // tickInitStoreNetwork
            patchMemoryFromString(0x082f4eab, "e950010000"); // tickWaitDHCP
            patchMemoryFromString(0x082f6d0b, "EB");         // Skip Kickback initialization
            patchMemoryFromString(0x087ea78c, "72");         // Skips initialization
            patchMemoryFromString(0x087ea79c, "ef");         // Skips initialization
            setVariable(0x0859a109, 0x000126e9);             // Avoid Full Screen set from Game
            ...
            if (GPUVendor != NVIDIA_GPU)
            {
                ...
                detourFunction(0x0807ac48, gl_TexCoord2f);
                detourFunction(0x0807ace8, cg_GLIsProfileSupported);
                // patchMemoryFromString(0x08564c30, "9090");
                cacheModedShaderFiles();
                detourFunction(0x0807b1b8, gl_XGetProcAddressARB);
                detourFunction(0x0807af28, gl_ProgramParameters4fvNV);
                if (GPUVendor == ATI_GPU)
            ...
            patchMemoryFromString(0x08589863, "31C090"); // cgCreateProgram args argument to 0;
            detourFunction(0x08271c6e, stubRetOne);      // isExistNewerSource (forces shader recompilation)

            // Patch for Card Reader to use files instead
            if (getConfig()->emulateIDCardReader)
            {
                patchMemoryFromString(0x0820a921, "88a9"); // RealCard --> FileCard
                patchMemoryFromString((size_t)findStaticFnAddr("_ZN11cFileCardIF9emulationEv") + 0x21, "74");
                detourFunction((size_t)findStaticFnAddr("_ZN11_sInterface10checkTrgOnENS_11PORT_NUMBEREm"), checkTrgOn);
                idCardSize = 1824;
                idTwoDigitsCardCount = true;
        ...
        case INITIALD_5_EXP_SBRY:
        {
            ...
            if (GPUVendor != NVIDIA_GPU)
            {
                ...
                // For ATI
                if (GPUVendor == ATI_GPU)
                    detourFunction(0x0807ab70, gl_ProgramStringARB);
            }
#ifdef _WIN32
            if (GPUVendor != NVIDIA_GPU && GPUVendor != AMD_GPU)
        ...
        case INITIALD_5_EXP20_SBTS:
        {
            ...
            if (GPUVendor != NVIDIA_GPU)
            {
                ...
                // For ATI
                if (GPUVendor == ATI_GPU)
                    detourFunction(0x0807ae60, gl_ProgramStringARB);
            }
        ...
        break;
        case INITIALD_5_JAP_SBQZ_REVA: // ID5 - DVP-0070A
        {
            if (config->showDebugMessages == 1)
            {
        ...
        break;
        case INITIALD_5_JAP_SBQZ_REVC: // ID5 - DVP-0070C
        {
            if (config->showDebugMessages == 1)
            {
            ...
            // patchMemoryFromString(0x084e221f, "00"); // Patch KEYCHECK
        ...
        break;
        case INITIALD_5_JAP_SBQZ_REVF: // ID5 - DVP-0070F
        {
            if (config->showDebugMessages == 1)
            {
            ...
            if (GPUVendor != NVIDIA_GPU)
            {
                ...
                cacheModedShaderFiles();
                if (GPUVendor == ATI_GPU)
                    detourFunction(0x0807ab9c, gl_ProgramStringARB);
            }
        ...
        case INITIALD_5_JAP_SBQZ_SERVERBOX:
        {
            ...
            // Removed because it is not implemented in windows
#ifdef __linux__
            detourFunction(0x0807f74e, getHostByName);
#endif

            patchMemoryFromString(0x0807fe5a, "e9e9000000"); // Skip network setup
                                                             // replaceCallAtAddress(0x08080222, myalAbExInit);
                                                             // patchMemory(0x08107dff, "90909090909090");
        }
        break;

        case LETS_GO_JUNGLE_SBLU:
        {
            if (config->showDebugMessages == 1)
            {
        ...
        break;
        case LETS_GO_JUNGLE_SBNR_SPECIAL:
        {
            if (config->showDebugMessages == 1)
            {
        ...
        case OUTRUN_2_SP_SDX_SBMB:
        {
            ...
            if (GPUVendor != NVIDIA_GPU)
            {
                detourFunction(0x0804cf38, gl_GenProgramsNV);          // Replaces glGenProgramsNV
                ...
                detourFunction(0x0804c938, gl_ProgramParameter4fvNV);  // Replaces glProgramParameter4fvNV
                detourFunction(0x0804ce18, gl_ProgramParameters4fvNV); // Replaces glProgramParameters4fvNV
                detourFunction(0x0804cec8, gl_ProgramParameter4fNV);   // Replaces glProgramParameter4fNV
                detourFunction(0x0804cb98, gl_IsProgramNV);            // Replaces glIsProgramNV
                detourFunction(0x0804c568, gl_EndOcclusionQueryNV);    // Replaces glEndOcclusionQueryNV
                detourFunction(0x0804d498, gl_GetOcclusionQueryuivNV); // Replaces glGetOcclusionQueryuivNV
                detourFunction(0x0804d648, gl_GenOcclusionQueriesNV);  // Replaces glGenOcclusionQueriesNV
        ...
        break;
        case OUTRUN_2_SP_SDX_SBMB_REVA:
        {
            if (config->showDebugMessages == 1)
            {
                // Debug Messages
        ...
        case OUTRUN_2_SP_SDX_SBMB_REVA_TEST2:
        {
            // Security
            ...
            if (gId == OUTRUN_2_SP_SDX_SBMB_REVA_TEST2)
            {
        ...
        case SEGABOOT_2_4_SYM:
        {
            ...
            amDipswContextAddr = (void *)0x0809c12c;
            detourFunction(0x0805c200, amDipswInit);
            detourFunction(0x0805c383, amDipswSetLed);
        }
        break;
        case SEGA_RACE_TV_SBPF:
        {
            // Security
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_4_SBLC_REVA:
        {
            if (config->showDebugMessages == 1)
            {
                // Debug Messages
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_4_SBLC_REVA_TEST:
        {
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_4_SBLC_REVB:
        {
            if (config->showDebugMessages == 1)
            {
                // Debug Messages
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_4_SBLC_REVB_TEST:
        {
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_4_SBLC_REVC:
        {
            // Security
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_4_SBLC_REVC_TEST:
        {
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_4_SPECIAL_SBLS:
        {
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_4_SPECIAL_SBLS_REVB:
        {
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_4_SPECIAL_SBLS_REVB_TEST:
        {
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_4_SPECIAL_SBLS_TEST:
        {
...
#ifdef _WIN32
            replaceCallAtAddress(0x0844176a, stubRetOne);
            replaceCallAtAddress(0x084417cd, stubRetOne);
#endif
        ...
        break;
        case THE_HOUSE_OF_THE_DEAD_EX_SBRC_TEST:
        {
        ...
        break;
        case VIRTUA_FIGHTER_5_SBLM_EXPORT:
        {
            // Security
        ...
        break;
        case VIRTUA_FIGHTER_5_SBQU_R_REVD:
        {
            // Security
        ...
        break;
        case VIRTUA_FIGHTER_5_SBQU_R_REVG:
        {
            // Security
        ...
        break;
        case VIRTUA_FIGHTER_5_SBQU_REVA:
        {
            // Security
        ...
        break;
        case VIRTUA_FIGHTER_5_SBQU_REVB:
        {
            // Security
        ...
        break;
        case VIRTUA_FIGHTER_5_SBQU_REVE: // Also the public REV C version
        {
            // Security
        ...
        break;
        case VIRTUA_TENNIS_3_SBKX_TEST:
        {
            if (config->showDebugMessages == 1)
            {
                // Debug
        ...
        break;
        case VIRTUA_TENNIS_3_SBKX_REVA:
        {
            if (config->showDebugMessages == 1)
            {
                // Debug
        ...
        break;
        case VIRTUA_TENNIS_3_SBKX_REVA_TEST:
        {
            if (config->showDebugMessages == 1)
            {
                // Debug
        ...
        break;
        case VIRTUA_TENNIS_3_SBKX_REVB:
        {
            if (config->showDebugMessages == 1)
            {
                // Debug
        ...
        break;
        case VIRTUA_TENNIS_3_SBKX_REVB_TEST:
        {
            if (config->showDebugMessages == 1)
            {
                // Debug
        ...
        break;
        case VIRTUA_TENNIS_3_SBKX_REVC:
        {
            if (config->showDebugMessages == 1)
            {
                // Debug
        ...
        break;
        case VIRTUA_TENNIS_3_SBKX_REVC_TEST:
        {
            if (config->showDebugMessages == 1)
            {
                // Debug
